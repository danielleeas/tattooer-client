...
import DepositReminderEmail from '@/app/emails/DepositReminder';
...
export async function POST(req: Request) {
    try {
        ...
        const { to, email_templates, avatar_url, variables } = await req.json();
        ...
        const html = await render(DepositReminderEmail({ email_templates, avatar_url, variables }));
