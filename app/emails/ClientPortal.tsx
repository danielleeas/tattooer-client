                ...
                <Body className="mx-auto my-auto max-w-[600px]">
                    <Container className="mx-auto max-w-[600px] py-[40px] px-4" style={{ backgroundColor: '#05080F' }}>
                        <Section className="mx-auto max-w-[472px]" style={{ backgroundColor: '#05080F' }}>
                            <Row>
                                ...
                                <Column className="mobile-block" style={{ verticalAlign: 'middle' }}>
                                    <Heading style={{ color: '#F0F0F0' }} className="text-[24px] font-normal p-0 m-0 text-left mobile-center">Your Client Portal</Heading>
                        ...
                        <Section className='mt-[28px] mx-auto max-w-[472px]' style={{ backgroundColor: '#05080F' }}>
                            <Text style={{ color: '#F0F0F0' }} className="text-[16px] leading-[20px] my-0 mb-4">Hi {clientName}.</Text>
                            <Text style={{ color: '#F0F0F0' }} className="text-[16px] leading-[20px] my-0 mb-4">I&apos;m so excited to be working with you. As a perk of being my client, you now get access to your exclusive Client Portal — powered by Simple Tattooer.</Text>
                            <Text style={{ color: '#F0F0F0' }} className="text-[16px] leading-[20px] my-0 mb-6">Inside your personal dashboard, you&apos;ll find your appointment details, payment info and receipts, my aftercare + FAQ pages, a reschedule/cancel button if anything changes, and a direct message portal to reach me anytime.</Text>
                            ...
                            <Text style={{ color: '#F0F0F0' }} className="text-[16px] leading-[20px] my-0">This is your private space — built just for you.</Text>
                            <Text style={{ color: '#F0F0F0' }} className="text-[16px] leading-[20px] my-0 mb-4">Can&apos;t wait to see you soon,</Text>
                            <Text style={{ color: '#F0F0F0' }} className="text-[16px] leading-[20px] my-0">{artistName}</Text>
                            <Text style={{ color: '#F0F0F0' }} className="text-[16px] leading-[20px] my-0 mb-4">{studioName}</Text>
                        </Section>
