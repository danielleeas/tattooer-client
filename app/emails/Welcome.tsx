                ...
                <Body className="mx-auto my-auto max-w-[600px]">
                    <Container className="mx-auto max-w-[600px] py-[40px] px-4" style={{ backgroundColor: '#05080F !important' }}>
                        ...
                        <Section className='mt-[28px] mx-auto max-w-[472px]' style={{ backgroundColor: '#05080F !important' }}>
                            <Text style={{ color: '#F0F0F0 !important' }} className="text-[16px] leading-[20px] my-0 mb-4">Hi {artistName}, weclome to Simple Tattooer!</Text>
                            <Text style={{ color: '#F0F0F0 !important' }} className="text-[16px] leading-[20px] my-0 mb-4">Your subscription is active, and your account is set up!</Text>
                            <Text style={{ color: '#F0F0F0 !important' }} className="text-[16px] leading-[20px] my-0 mb-0">Your Personal Booking Link and matching QR code are below(this can be edited anytime in Your Settings in the app):</Text>
                            ...
                            <Img
                                ...
                                className="mb-4"
                            />
                            <Text style={{ color: '#F0F0F0 !important' }} className="text-[16px] leading-[20px] my-0 mb-4">Share it on Instagram, your website, or anywhere else so clients can fill out your booking form, make a consultation appointment, and more.</Text>
                            <Text style={{ color: '#F0F0F0 !important' }} className="text-[16px] leading-[20px] my-0 mb-4">Need help with the app? We&apos;ve made short walkthrough videos for every feature:</Text>
                            ...
                            <Text style={{ color: '#F0F0F0 !important' }} className="text-[16px] leading-[20px] my-0 mt-4">Thanks for being here —</Text>
